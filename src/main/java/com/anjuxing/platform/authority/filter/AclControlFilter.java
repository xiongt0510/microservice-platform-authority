...
import com.anjuxing.platform.authority.common.ApplicationContextHelper;
...
public class AclControlFilter implements Filter {
    ...
    private final static String noAuthUrl = "/sys/user/noAuth";

    /**
     * 添加exclusionUrls 并把 noAuthUrl添加进去
     * @param filterConfig
    ...
    private void  noAuth(HttpServletRequest request,HttpServletResponse response) throws IOException {
        String servletPath = request.getServletPath();
        if (RequestHolder.isJsonRequest(request,response)){
